...
\begin{center}
    ...
    \end{lstlisting}
    \captionof{figure}{Inititating SSO using custom \texttt{web+paranoid} protocol.}
...
\begin{center}
    ...
    \end{lstlisting}
    \captionof{figure}{Example field map, accessible through domain.com/paranoid_map path.}
